...
<html lang="en">
            ...
            <div class="">
              <div class="page-title">
                <div class="title_left">
                  <h3>
                        Form Update Kegiatan Pengabdian Masyarakat
                  </h3>
                </div>
              ...
              <div class="clearfix"></div>
                      ...
                      <form action="proses-kegpengabdian-update.php" method="post" class="form-horizontal form-label-left" novalidate>
    ...
    echo '<input id="name" value = "'.$_SESSION['user'].'" name="form-nip"  required="required" type="hidden">';
                ...
                ?>
                          ...
                          $query="SELECT IDKEGIATANPENGABDIANMASYARAKAT FROM kegiatanpengabdianmasyarakat WHERE IDKEGIATANPENGABDIANMASYARAKAT=".$_GET['id']."";
                          ...
                          <input id="name" value = "<?php echo $data2['IDKEGIATANPENGABDIANMASYARAKAT']?>" name="form-idkegpengabdian"  required="required" type="hidden">
