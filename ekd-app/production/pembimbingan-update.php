      ...
      <div class="right_col" role="main">
        ...
        <div class="">
          ...
          <div class="clearfix"></div>
            ...
            <form action="proses-pembimbingan-update.php" method="post" class="form-horizontal form-label-left" novalidate>
...
<!--                        <input id="name" class="form-control col-md-7 col-xs-12" name="form-nama_mhs" placeholder="$_POST['nama_mhs']" required="required" type="text">-->
                          ...
                          $query="SELECT * FROM pembimbingan WHERE id_pembimbingan=".$_GET['id']."";
                          ...
                          <input id="name" class="form-control col-md-7 col-xs-12" value = "<?php echo $data2['nama_mhs']?>" name="form-nama_mhs" placeholder="$_POST['nama_mhs']" required="required" type="text">
                          <input id="name"  value = "<?php echo $data2['id_pembimbingan']?>" name="form-id" required="required" type="hidden">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" value = "<?php echo $data2['nim_mhs']?>" name="form-nim_mhs" required="required" type="text">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-7 col-xs-12" value = "<?php echo $data2['judul']?>" name="form-judul" required="required" type="text">
<!--
                           <form action ="">
