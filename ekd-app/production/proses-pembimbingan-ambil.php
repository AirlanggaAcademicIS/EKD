        ...
        public function getPembimbingan(){
			...
			if(mysqli_num_rows($result)>0){
				while($data = mysqli_fetch_array($result)){
                    echo "<tr>";
                    echo "<td>".$this -> id_pembimbingan=$data['id_pembimbingan']."</td>";
                    ...
                    echo "<td>"."<a href='pembimbingan-update.php?id=".$this -> id_pembimbingan=$data['id_pembimbingan']."'><button class='btn btn-primary'>Update</button></a>"."<a href='proses-pembimbingan-delete.php?id=".$this -> id_pembimbingan=$data['id_pembimbingan']."'><button class='btn btn-primary'>Delete</button></a>"."</td>";
