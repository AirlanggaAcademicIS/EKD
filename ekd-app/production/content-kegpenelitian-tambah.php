...
<html lang="en">
            ...
            <div class="">
              <div class="page-title">
                <div class="title_left">
                  <h3>
                        Form Tambah Kegiatan Penelitian
                  </h3>
                </div>
    ...
    echo '<input id="name" value = "'.$_SESSION['user'].'" name="form-nip"  required="required" type="hidden">';
                ...
                ?>
                          ...
                          <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Penelitian <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="form-penelitian" id="form-lingkup" class="form-control" required>
                              <option value="">Pilih Penelitian </option>
                              <?php include 'populate-penelitian.php'; ?>
                            </select>
                            </div>
                        </div>
                        
                          <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Kontribusi dalam Kegiatan Penelitian <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="form-kontrib" id="form-lingkup" class="form-control" required>
                        ...
                        <div class="form-group">
                          <div class="col-md-6 col-md-offset-3">
                            <button id="send" type="submit" class="btn btn-success" name="form-submit" value="Submit">Saya Berkontibusi dalam Penelitian ini</button>
                          </div>
                        </div>
                      </form>
            </div>
