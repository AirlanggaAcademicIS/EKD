...
<html lang="en">
            ...
            <div class="">
              <div class="page-title">
                <div class="title_left">
                  <h3>
                        Form Update Kegiatan Pendidikan dan Pengajaran
                  </h3>
                </div>
              ...
              <div class="clearfix"></div>
                      ...
                      <form action="proses-pendpeng-update.php" method="post" class="form-horizontal form-label-left" novalidate>
    ...
    echo '<input id="name" value = "'.$_SESSION['user'].'" name="form-nip"  required="required" type="hidden">';
                ...
                ?>
                          ...
                          $query="SELECT IDPENDIDIKANPENGAJARAN FROM pendidikanpengajaran WHERE IDPENDIDIKANPENGAJARAN=".$_GET['id']."";
                          ...
                          <input id="name" value = "<?php echo $data2['IDPENDIDIKANPENGAJARAN']?>" name="form-idkegpengabdian"  required="required" type="hidden">
                          ...
                          <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Kegiatan <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="form-keg" id="form-lingkup" class="form-control" required>
                              <option value="">Pilih Kegiatan </option>
                              <?php include 'populate-kegiatan.php'; ?>
                            </select>
                            </div>
                        </div>
