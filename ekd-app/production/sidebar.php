                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-edit"></i>Pendidikan Pengajaran <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="%">Tambah Data Pendidikan dan Pengajaran</a></li>
                            <li><a href="%">Lihat Data Pendidikan dan Pengajaran</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-edit"></i>Pembimbingan <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="%">Tambah Data Pembimbingan</a></li>
                            <li><a href="%">Lihat Data Pembimbingan</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-edit"></i>Penelitian <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="%">Tambah Data Penelitian</a></li>
                            <li><a href="%">Lihat Data Penelitian</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a><i class="fa fa-edit"></i>Perolehan HAKI <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                            <li><a href="%">Tambah Data Perolehan HAKI</a></li>
                            <li><a href="%">Lihat Data Perolehan HAKI</a></li>
                        </ul>
                    </li>
