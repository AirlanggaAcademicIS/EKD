            ...
            <div class="">
              ...
              <div class="clearfix"></div>
                      ...
                      <form action="proses-pengabdian-tambah.php" method="post" class="form-horizontal form-label-left" novalidate>
                        ...
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Sumber Dana <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="item form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Jumlah (Juta Rp.) <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
