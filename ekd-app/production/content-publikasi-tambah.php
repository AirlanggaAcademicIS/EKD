          ...
          <div class="right_col" role="main">
            ...
            <div class="">
              ...
              <div class="clearfix"></div>
                      ...
                      <form action="proses-publikasi-tambah.php" method="post" class="form-horizontal form-label-left" novalidate>
    ...
    echo '<input id="name" value = "'.$_SESSION['user'].'" name="form-nip"  required="required" type="hidden">';
                ...
                ?>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="email" name="form-atribut" required="required" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="number" name="form-namajurnal" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        <div class="item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          $result=mysqli_query($connection, $query);
                              ...
                              if(isset($_POST['bukti-sk']))
                                  if($_POST['bukti-sk']==$data['KETERANGAN']){
