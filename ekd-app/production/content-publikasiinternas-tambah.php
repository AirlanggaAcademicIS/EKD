              ...
              <div class="clearfix"></div>
                      ...
                      <form class="form-horizontal form-label-left" novalidate>
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="email" name="form-kelengkapan" required="required" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="form-kontib" class="form-control" required>
                              <option value="">Pilih. . . </option>
                              <option value="press">Ketua</option>
                              <option value="net">Anggota</option>
                            </select>
                            </div>
                        </div>
                        <div class="item form-group">
                          ...
                          <select id="form-kontib" class="form-control" required>
                              <option value="">Pilih. . . </option>
                              <option value="press">Terakreditasi DIKTI</option>
                              <option value="net">Tidak</option>
                            </select>
                            </div>
                        </div>
